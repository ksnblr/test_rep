import pyodbc 
import pandas as pd
output_file = open('../db_output.txt','w')
conn = pyodbc.connect('DRIVER={ODBC Driver 17 for SQL Server};SERVER=db-pvdsqlsim;DATABASE=QAOpsReport;UID=qaopswrite;PWD=q@opswrite!;Trusted_Connection=yes')
cursor=conn.cursor()
...
try:
    ...
    df = pd.read_excel("Q:\\qa\\work_areas\\xkk\\do_not_delete\\21x_role_irs_source\\irs_21x.xlsx",header=None,sheet_name=1)
    df1 = pd.read_excel("Q:\\qa\\work_areas\\xkk\\do_not_delete\\21x_role_irs_source\\irs_20x.xlsx",header=None,sheet_name=1)
    df2 = pd.read_excel("Q:\\qa\\work_areas\\xkk\\do_not_delete\\21x_role_irs_source\\irs_19x.xlsx",header=None,sheet_name=1)
    df3 = pd.read_excel("Q:\\qa\\work_areas\\xkk\\do_not_delete\\21x_role_irs_source\\scenario_replay_data.xlsx",header=None,sheet_name=2)
    df4 = pd.read_excel("Q:\\qa\\work_areas\\xkk\\do_not_delete\\21x_role_irs_source\\function_data.xlsx",header=None,sheet_name=5)
    df5 = pd.read_excel("Q:\\qa\\work_areas\\xkk\\do_not_delete\\21x_role_irs_source\\IRS_data.xlsx",header=None,sheet_name=0)
...
try:
    ...
    df = pd.read_excel("Q:\\qa\\work_areas\\xkk\\do_not_delete\\21x_role_irs_source\\irs_21x.xlsx",header=None,sheet_name=0)
    df1 = pd.read_excel("Q:\\qa\\work_areas\\xkk\\do_not_delete\\21x_role_irs_source\\irs_20x.xlsx",header=None,sheet_name=0)
    df2 = pd.read_excel("Q:\\qa\\work_areas\\xkk\\do_not_delete\\21x_role_irs_source\\irs_19x.xlsx",header=None,sheet_name=0)
...
try:
    ...
    df_scen = pd.read_excel("Q:\\qa\\work_areas\\xkk\\do_not_delete\\21x_role_irs_source\\scenario_replay_data.xlsx",header=None,sheet_name=0)
...
try:
    ...
    df_scen_ir = pd.read_excel("Q:\\qa\\work_areas\\xkk\\do_not_delete\\21x_role_irs_source\\scenario_replay_data.xlsx",header=None,sheet_name=1)
...
try:
    ...
    df_function = pd.read_excel("Q:\\qa\\work_areas\\xkk\\do_not_delete\\21x_role_irs_source\\function_data.xlsx",header=None,sheet_name=0)
...
try:
    df_fqa = pd.read_excel("Q:\\qa\\work_areas\\xkk\\do_not_delete\\21x_role_irs_source\\function_data.xlsx",header=None,sheet_name=1)
...
try:
    df_fir = pd.read_excel("Q:\\qa\\work_areas\\xkk\\do_not_delete\\21x_role_irs_source\\function_data.xlsx",header=None,sheet_name=2)
...
try:
    df_qaj = pd.read_excel("Q:\\qa\\work_areas\\xkk\\do_not_delete\\21x_role_irs_source\\function_data.xlsx",header=None,sheet_name=3)
...
try:
    df_fun_irs = pd.read_excel("Q:\\qa\\work_areas\\xkk\\do_not_delete\\21x_role_irs_source\\function_data.xlsx",header=None,sheet_name=4)
